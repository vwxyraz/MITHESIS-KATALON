...
//tolak ajuan
tolakButton = findTestObject('Object Repository/Page_Sidang  myITS Thesis/buttonTolakAjuan')
WebUI.waitForElementVisible(tolakButton, 0)
WebUI.click(tolakButton)

confirmTolak = findTestObject('Object Repository/Page_Sidang  myITS Thesis/buttonKonfirmasiTolak')
WebUI.waitForElementVisible(confirmTolak, 0)
WebUI.click(confirmTolak)

WebUI.verifyTextPresent('Ajuan sidang berhasil ditolak.', false)

WebUI.verifyTextPresent('Ajuan sidang ditolak', false)
