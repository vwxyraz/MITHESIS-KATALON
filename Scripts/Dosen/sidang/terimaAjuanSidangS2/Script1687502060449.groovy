...
tabTesis = findTestObject('Object Repository/Page_Sidang  myITS Thesis/tab_tesis')
WebUI.waitForElementVisible(tabTesis, 0)
WebUI.click(tabTesis)

ajuanSidang = findTestObject('Object Repository/Page_Sidang  myITS Thesis/tesis_ajuansidang')
WebUI.waitForElementVisible(ajuanSidang, 0)
WebUI.click(ajuanSidang)

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Sidang  myITS Thesis/tesis_table'), 0)
