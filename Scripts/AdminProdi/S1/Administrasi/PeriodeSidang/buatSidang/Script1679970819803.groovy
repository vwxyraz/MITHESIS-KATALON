...
//syarat
WebUI.click(findTestObject('Object Repository/Page_PeriodeSidang/tambahSyaratButton'))
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PeriodeSidang/deleteTambahPrasyarat'), 0)
WebUI.click(findTestObject('Object Repository/Page_PeriodeSidang/deleteTambahPrasyarat'))
