...
publish = findTestObject('Object Repository/Page_PeriodeSidang/umumkanSidang')
WebUI.waitForElementVisible(publish, 0)
WebUI.click(publish)

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PeriodeSidang/modalPublikasikan'), 0)
