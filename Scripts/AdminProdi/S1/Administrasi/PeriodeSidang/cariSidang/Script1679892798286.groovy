...
WebUI.click(search)
WebUI.setText(search, 'Sidang Akhir')
WebUI.verifyElementPresent(search, 0)

def nama = WebUI.getText(findTestObject('Object Repository/Page_PeriodeSidang/namaSidang'))
if (nama.contains('Sidang Akhir')) {
	print(nama.contains('Sidang Akhir'))
}
else {
