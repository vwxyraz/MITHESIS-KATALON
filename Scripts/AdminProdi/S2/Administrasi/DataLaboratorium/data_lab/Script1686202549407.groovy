...
buttonDataLab = findTestObject('Object Repository/Page_Administrasi/dataLaboratorium')

WebUI.waitForElementVisible(buttonAdministrasi, 0)
WebUI.click(buttonAdministrasi)
WebUI.waitForElementVisible(buttonDataLab, 0)
WebUI.click(buttonDataLab)

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_DataLab/table'), 0)