...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PeriodeSidang/buttonMore'), 0)
WebUI.click(findTestObject('Object Repository/Page_PeriodeSidang/buttonMore'))
WebUI.click(findTestObject('Object Repository/Page_PeriodeSidang/buttonHapus'))
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PeriodeSidang/moduleHapusSidang'), 0)
WebUI.click(findTestObject('Object Repository/Page_PeriodeSidang/buttonDelete'))

//
WebUI.verifyTextPresent('Periode sidang berhasil dihapus!', false)