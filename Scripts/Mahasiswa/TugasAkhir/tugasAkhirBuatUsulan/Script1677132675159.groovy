...
selectLab = findTestObject('Object Repository/Page_Detail Tugas Akhir  myITS Thesis/selectLab')
...
//WebUI.click(selectLab)
//WebUI.waitForElementVisible(inputSelect, 0)
//WebUI.click(inputSelect)
//WebUI.setText(inputSelect, 'rekayasa')
//WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Detail Tugas Akhir  myITS Thesis/selectResultLab'), 0)
//WebUI.click(inputSelect)
...
//tidak berkelompok
WebUI.click(findTestObject('Object Repository/Page_Detail Tugas Akhir  myITS Thesis/buttonTidakBerkelompok'))
